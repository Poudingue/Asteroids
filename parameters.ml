...
let asteroid_max_spawn_radius = 650. (*Taille max d'astéroïde au spawn.*)
...
let cooldown_tp = 5.
let tp_time_invic = 1.(*Temps d'invincibilité après tp. TODO : implémenter*)
...
let projectile_radius_hitbox = ref 20. (*On fait une hitbox plus grande pour être généreux sur les collisions*)
