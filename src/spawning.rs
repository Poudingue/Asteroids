use crate::math_utils::{add_vec, from_polar, rand_range, scale_vec, squared, Vec2};
use crate::objects::{
    Entity, EntityKind, ExplosionObjectSideEffects, Hitbox, Polygon, Star, Visuals,
};
...
// ============================================================================
// Spawn functions (extracted from objects.rs)
// ============================================================================
