...
- [ ] [rendering/hdr] Map HDR output to lower spectral volume when display gamut info is available (e.g., sRGB display gets gamut-mapped P3 colors) (severity: minor, 2026-04-04)
